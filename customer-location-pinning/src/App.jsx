...
const App = () => {
    ...
    const handleUpdateCustomer = (customerData) => {
        setIsLoading(true);
        apiService.updateCustomer(selectedCustomer._id, customerData)
            .then(() => {
                fetchCustomers();
    ...
    const fetchCustomers = async () => {
        setIsLoading(true);
        try {
            const response = await apiService.getCustomers(currentPage, customersPerPage);
    ...
    useEffect(() => {
        const fetchCustomerCount = async () => {
            setIsLoading(true);
            try {
                const response = await apiService.getCustomerCount();
    ...
    return (
        <div className="App p-4">
            ...
            <div className="flex flex-col md:flex-row"> {/* Make form and map stack on small screens */}
            ...
            {isLoading ? (
                ...
                <ul className="list-none p-0">
                    {customers.map((customer) => (
                        <li key={customer._id} className="mb-4 p-4 border rounded shadow-md">
